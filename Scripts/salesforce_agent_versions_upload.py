...
if token_exch_response.status_code == 200:
    ...
    if token:
        ...
        consolidated_file = 'agent_version_summary.csv'
        account_updates = {}
        ...
        with open(consolidated_file, mode='r') as file:
            ...
            for row in reader:
                ...
                agent_versions_raw = row['agent_version_data'].strip()  
                ...
                # Process Agent Versions
                if agent_versions_raw:
                    update_payload = {
                        "Agent_Version_s__c": agent_versions_raw  # Send the raw string directly
                    }
